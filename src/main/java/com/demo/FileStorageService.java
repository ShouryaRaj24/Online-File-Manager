...
public class FileStorageService {
    ...
    public static final String STORAGE_DIRECTORY = "C:\\Users\\root\\Desktop\\File_Save";
    ...
    public void saveFile(MultipartFile fileToSave) throws IOException {
        ...
        if (!Objects.equals(targetFile.getParent(), STORAGE_DIRECTORY)) {                                        //Security Check
    ...
    public File getDownloadFile(String fileName) throws Exception {
        ...
        if (!Objects.equals(fileToDownload.getParent(), STORAGE_DIRECTORY)) {                                    //Security Check
            throw new SecurityException("Unsupported filename!");
        }
